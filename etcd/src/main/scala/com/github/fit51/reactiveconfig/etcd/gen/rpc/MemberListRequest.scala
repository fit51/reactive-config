...
final case class MemberListRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[MemberListRequest] {
    @transient
    ...
    // @@protoc_insertion_point(GeneratedMessage[etcdserverpb.MemberListRequest])
}
...
object MemberListRequest extends scalapb.GeneratedMessageCompanion[com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberListRequest] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberListRequest = {
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[etcdserverpb.MemberListRequest])
}
