...
final case class MemberRemoveResponse(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.Message[MemberRemoveResponse] with scalapb.lenses.Updatable[MemberRemoveResponse] {
    @transient
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberRemoveResponse = {
...
object MemberRemoveResponse extends scalapb.GeneratedMessageCompanion[com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberRemoveResponse] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberRemoveResponse = {
