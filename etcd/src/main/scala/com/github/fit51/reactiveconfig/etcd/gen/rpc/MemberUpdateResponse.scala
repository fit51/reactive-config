...
final case class MemberUpdateResponse(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[MemberUpdateResponse] {
    @transient
    ...
    // @@protoc_insertion_point(GeneratedMessage[etcdserverpb.MemberUpdateResponse])
}
...
object MemberUpdateResponse extends scalapb.GeneratedMessageCompanion[com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberUpdateResponse] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberUpdateResponse = {
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[etcdserverpb.MemberUpdateResponse])
}
