...
final case class MemberListResponse(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[MemberListResponse] {
    @transient
    ...
    // @@protoc_insertion_point(GeneratedMessage[etcdserverpb.MemberListResponse])
}
...
object MemberListResponse extends scalapb.GeneratedMessageCompanion[com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberListResponse] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberListResponse = {
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[etcdserverpb.MemberListResponse])
}
