...
final case class PutResponse(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[PutResponse] {
    @transient
    ...
    // @@protoc_insertion_point(GeneratedMessage[etcdserverpb.PutResponse])
}
...
object PutResponse extends scalapb.GeneratedMessageCompanion[com.github.fit51.reactiveconfig.etcd.gen.rpc.PutResponse] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.github.fit51.reactiveconfig.etcd.gen.rpc.PutResponse = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.github.fit51.reactiveconfig.etcd.gen.rpc.PutResponse] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.github.fit51.reactiveconfig.etcd.gen.rpc.PutResponse(
        ...
        prevKv = __fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).flatMap(_.as[_root_.scala.Option[com.github.fit51.reactiveconfig.etcd.gen.kv.KeyValue]])
      )
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[etcdserverpb.PutResponse])
}
