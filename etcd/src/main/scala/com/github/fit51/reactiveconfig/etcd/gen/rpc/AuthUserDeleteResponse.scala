...
final case class AuthUserDeleteResponse(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[AuthUserDeleteResponse] {
    @transient
    ...
    // @@protoc_insertion_point(GeneratedMessage[etcdserverpb.AuthUserDeleteResponse])
}
...
object AuthUserDeleteResponse extends scalapb.GeneratedMessageCompanion[com.github.fit51.reactiveconfig.etcd.gen.rpc.AuthUserDeleteResponse] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.github.fit51.reactiveconfig.etcd.gen.rpc.AuthUserDeleteResponse = {
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[etcdserverpb.AuthUserDeleteResponse])
}
