...
final case class LeaseTimeToLiveRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.Message[LeaseTimeToLiveRequest] with scalapb.lenses.Updatable[LeaseTimeToLiveRequest] {
    @transient
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.github.fit51.reactiveconfig.etcd.gen.rpc.LeaseTimeToLiveRequest = {
      var __iD = this.iD
      var __keys = this.keys
      var _done__ = false
      while (!_done__) {
...
object LeaseTimeToLiveRequest extends scalapb.GeneratedMessageCompanion[com.github.fit51.reactiveconfig.etcd.gen.rpc.LeaseTimeToLiveRequest] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): com.github.fit51.reactiveconfig.etcd.gen.rpc.LeaseTimeToLiveRequest = {
