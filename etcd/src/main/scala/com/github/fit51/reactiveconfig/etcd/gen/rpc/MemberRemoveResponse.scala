...
/** @param members
  ...
  */
@SerialVersionUID(0L)
final case class MemberRemoveResponse(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[MemberRemoveResponse] {
    @transient
    ...
    def clearHeader: MemberRemoveResponse = copy(header = _root_.scala.None)
    def withHeader(__v: com.github.fit51.reactiveconfig.etcd.gen.rpc.ResponseHeader): MemberRemoveResponse = copy(header = Option(__v))
    def clearMembers = copy(members = _root_.scala.Seq.empty)
    def addMembers(__vs: com.github.fit51.reactiveconfig.etcd.gen.rpc.Member*): MemberRemoveResponse = addAllMembers(__vs)
    def addAllMembers(__vs: Iterable[com.github.fit51.reactiveconfig.etcd.gen.rpc.Member]): MemberRemoveResponse = copy(members = members ++ __vs)
    def withMembers(__v: _root_.scala.Seq[com.github.fit51.reactiveconfig.etcd.gen.rpc.Member]): MemberRemoveResponse = copy(members = __v)
    ...
    def companion = com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberRemoveResponse
    // @@protoc_insertion_point(GeneratedMessage[etcdserverpb.MemberRemoveResponse])
}

object MemberRemoveResponse extends scalapb.GeneratedMessageCompanion[com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberRemoveResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberRemoveResponse] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberRemoveResponse = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberRemoveResponse] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberRemoveResponse(
        ...
        members = __fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).map(_.as[_root_.scala.Seq[com.github.fit51.reactiveconfig.etcd.gen.rpc.Member]]).getOrElse(_root_.scala.Seq.empty)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = RpcProto.javaDescriptor.getMessageTypes().get(34)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = RpcProto.scalaDescriptor.messages(34)
  ...
  lazy val defaultInstance = com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberRemoveResponse(
    header = _root_.scala.None,
    members = _root_.scala.Seq.empty
  )
  implicit class MemberRemoveResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberRemoveResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberRemoveResponse](_l) {
  ...
  ): _root_.com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberRemoveResponse = _root_.com.github.fit51.reactiveconfig.etcd.gen.rpc.MemberRemoveResponse(
    header,
    members
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[etcdserverpb.MemberRemoveResponse])
}
