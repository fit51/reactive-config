...
final case class AuthUserGetRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[AuthUserGetRequest] {
    @transient
    ...
    // @@protoc_insertion_point(GeneratedMessage[etcdserverpb.AuthUserGetRequest])
}
...
object AuthUserGetRequest extends scalapb.GeneratedMessageCompanion[com.github.fit51.reactiveconfig.etcd.gen.rpc.AuthUserGetRequest] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.github.fit51.reactiveconfig.etcd.gen.rpc.AuthUserGetRequest = {
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[etcdserverpb.AuthUserGetRequest])
}
